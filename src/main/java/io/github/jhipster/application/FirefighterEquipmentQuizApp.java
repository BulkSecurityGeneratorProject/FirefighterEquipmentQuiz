...
public class FirefighterEquipmentQuizApp {

    private static final Logger log = LoggerFactory.getLogger(FirefighterEquipmentQuizApp.class);

    private final Environment env;

    public FirefighterEquipmentQuizApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes FirefighterEquipmentQuiz.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(FirefighterEquipmentQuizApp.class);
